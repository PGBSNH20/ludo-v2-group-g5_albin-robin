...
namespace LudoEngine.DbModel
{
    public static class DatabaseManagement
    {
        ...
        public static void SaveAndGetGame(TeamColor currentTurn)
        {
            ...
            var saveGame = new OldGame { CurrentTurn = currentTurn };
        ...
        public static List<OldGame> GetGames()
        {
            using var db = new LudoContext();
        ...
        public static List<PawnSavePoint> GetPawnPositionsInGame(OldGame game)
        {
            using var db = new LudoContext();
        ...
        public static List<OldGame> GetGameId(int playerId)
        {
            using var db = new LudoContext();
        ...
        private static void save(GamePlay gamePlay)
        {
            ...
            StageSaving.Pawns = BoardFinder.GetTeamPawns(currentTeam);
